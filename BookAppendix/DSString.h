...
public:
    ...
    /**
     * counts words and returns totals
     * @return an int
     */
    int numberOfWords();
    /**
     * finds word at specifc x location
     * @param x
     * @return DSString
     */
    DSString parse(int);
    /**
     * finds word at specifc x location (important because dsstring past will now allow some punct to be okay
     * @param x & DSString
     * @return DSString
     */
    DSString pars(int, DSString);
    /**
     * collects okay puncts found in terms file
     * @return a dsstring of all the puncts
     */
    DSString getPunct();
    /**
     * turns all characters to lower case, better for comparing
     */
    void all_Lower();
